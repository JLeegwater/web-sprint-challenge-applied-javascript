...
const cardAppender = (selector) => {
  ...
  axios
    ...
    .then((res) => {
      Object.values(res.data.articles).forEach((key) => {
        //console.log(key);
        key.forEach((obj) => {
...
// const javascript =[
//   {
//     "id":"1e4d8724-5973-4b5b-84d9-a30a3c5adb70","headline":"ES8: The Next Step in the Evolution of Javascript and What it Means For Your Projects",
